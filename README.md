...
These sample scenarios were executed using the [http](https://github.com/jkbrzt/httpie) command line utility. Replace ContactType with other resources such as ContactRelationshipType and Contact.

#### Create (ContactType) with basic authentication

All the mandatory fields are specified. Request:
