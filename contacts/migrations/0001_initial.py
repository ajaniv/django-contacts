    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='social_media.Phone')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(auto_now=True)),
                ('priority', models.PositiveSmallIntegerField(default=0)),
                ('uri', models.URLField(blank=True, max_length=255, null=True, validators=[django.core.validators.URLValidator(schemes=[b'aim', b'gtalk', b'im', b'msnim', b'skype', b'sms', b'xmpp', b'http', b'https', b'ftp', b'ftps', b'tel', b'mailto', b'urn'])])),
        ...
        migrations.AlterUniqueTogether(
            name='contactphone',
            unique_together=set([('contact', 'phone_number', 'phone_type')]),
        ),
        migrations.AlterUniqueTogether(
            name='contactorganization',
