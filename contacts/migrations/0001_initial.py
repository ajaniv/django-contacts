# -*- coding: utf-8 -*-
# Generated by Django 1.9.4 on 2016-05-15 23:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': (('read_contact', 'Can read contacts'), ('write_contact', 'Can write contacts')),
        ...
        migrations.CreateModel(
            name='ContactGroupObjectPermission',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('content_object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='contacts.Contact')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timezone', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='locations.Timezone')),
                ('timezone_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='locations.TimezoneType')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='organizations.Title')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(auto_now=True)),
                ('priority', models.PositiveSmallIntegerField(blank=True, default=0, null=True)),
                ('contact_relationship_type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='contacts.ContactRelationshipType')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('groups_read', models.ManyToManyField(db_table='sl_contacts_user_profile_groups_read', related_name='contacts_userprofile_related_groups_read', to='auth.Group')),
                ('groups_write', models.ManyToManyField(db_table='sl_contacts_user_profile_groups_write', related_name='contacts_userprofile_related_groups_write', to='auth.Group')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('users_read', models.ManyToManyField(db_table='sl_contacts_user_profile_users_read', related_name='contacts_userprofile_related_users_read', to=settings.AUTH_USER_MODEL)),
                ('users_write', models.ManyToManyField(db_table='sl_contacts_user_profile_users_write', related_name='contacts_userprofile_related_users_write', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'sl_contacts_user_profile',
        ...
        migrations.AddField(
            model_name='contact',
            name='titles',
            field=models.ManyToManyField(related_name='Title_set', through='contacts.ContactTitle', to='organizations.Title'),
        ),
        migrations.AddField(
            model_name='contact',
            name='update_user',
        ...
        migrations.AlterUniqueTogether(
            name='relatedcontact',
            unique_together=set([('from_contact', 'to_contact', 'contact_relationship_type')]),
        ),
        migrations.AlterUniqueTogether(
            name='contacturl',
        ...
        migrations.AlterUniqueTogether(
            name='contacttimezone',
            unique_together=set([('contact', 'timezone', 'timezone_type')]),
        ),
        migrations.AlterUniqueTogether(
            name='contactrole',
